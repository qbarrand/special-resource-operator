...
var fileProvider = getter.Provider{
	Schemes: []string{"file"},
	New:     NewFileGetter,
}
...
func (g *FileGetter) Get(href string, option ...getter.Option) (*bytes.Buffer, error) {
...
func NewFileGetter(options ...getter.Option) (getter.Getter, error) {
...
var configMapProvider = getter.Provider{
	Schemes: []string{"cm"},
...
func (g *ConfigMapGetter) Get(href string, option ...getter.Option) (*bytes.Buffer, error) {
...
func NewConfigMapGetter(options ...getter.Option) (getter.Getter, error) {
